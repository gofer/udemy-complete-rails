...
- メッセージ表示部にスクロールバーを追加する
- ページロード時・メッセージ受信時に最下部までスクロール位置を移動させる

## 237. Beautify input box, functionality and create custom scope

- メッセージを送信時にテキストボックス上でEnterキーを押すことで送信されるようにする
- メッセージ一覧のメッセージ数を最新の20件に限定する
